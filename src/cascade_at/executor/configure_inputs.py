...
if '/Users/gma/Projects/IHME/GIT/cascade_at.git' in sys.path:
    sys.path.remove('/Users/gma/Projects/IHME/GIT/cascade_at.git')
if '/Users/gma/Projects/IHME/GIT/cascade_ode.git' in sys.path:
    sys.path.remove('/Users/gma/Projects/IHME/GIT/cascade_ode.git')
if 1:
    if '/Users/gma/Projects/IHME/GIT/cascade_at_brad' in sys.path:
        sys.path.remove('/Users/gma/Projects/IHME/GIT/cascade_at_brad')
    import os
    sys.path = [os.path.abspath('./src')] + sys.path 

#gma# from cascade_at.executor.args.arg_utils import ArgumentList
#gma# from cascade_at.executor.args.args import ModelVersionID, BoolArg, LogLevel, StrArg
...
def main(argv):
    def parse_args(argv):
        ...
        parser.add_argument('--make', type=str2bool, nargs='?', default = False, const = True,
                            help='Whether or not to make the file structure for the cascade'),
        parser.add_argument('--configure', type=str2bool, nargs='?', default = False, const = True,
                            help='Whether or not to configure for the IHME cluster'),
        parser.add_argument('--json-file', type=str,
                            help='For testing, pass a json file directly by filepath instead of referencing a model version ID.'),
        parser.add_argument('--test-dir', type=str,
                            help='If set, will save files to the directory specified. Invalidated if --configure is set.')
